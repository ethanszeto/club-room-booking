...
INSERT INTO
  `building`
VALUES
  (1, 'BH', 'Behrakis Health Science Center'),
  (2, 'CSC', 'Curry Student Center'),
  (3, 'DG', 'Dodge Hall'),
  (4, 'EV', 'East Village'),
  (5, 'EC', 'Egan Center'),
  (6, 'EL', 'Ell Hall'),
  ...
  (9, 'IV', 'International Village'),
  (10, 'MC', 'Marino Center'),
  (11, 'RY', 'Ryder Hall'),
  (12, 'SH', 'Shillman Hall'),
  (13, 'SL', 'Snell Library'),
  (14, 'WVH', 'West Village H');
...
CREATE TABLE
  `meeting` (
    ...
    CONSTRAINT `meeting_ibfk_1` FOREIGN KEY (`room_id`, `start_time`, `end_time`) REFERENCES `meeting_group` (`room_id`, `start_time`, `end_time`) ON DELETE CASCADE ON UPDATE CASCADE
...
VALUES
  ...
  ('Classroom', 119),
  ('Lecture', 119),
  ('Group Study Room', 120),
  ('Group Study Room', 121),
  ('Group Study Room', 122),
  ('Group Study Room', 123),
  ('Group Study Room', 124),
  ('Group Study Room', 125),
  ('Group Study Room', 126),
  ('Group Study Room', 127),
  ('Group Study Room', 128),
  ('Group Study Room', 129),
  ('Group Study Room', 130),
  ('Group Study Room', 131),
  ('Group Study Room', 132),
  ('Group Study Room', 133),
  ('Group Study Room', 134),
  ('Group Study Room', 135),
  ('Individual Study Room', 136),
  ('Individual Study Room', 137),
  ('Individual Study Room', 138),
  ('Individual Study Room', 139),
  ('Individual Study Room', 140),
  ('Individual Study Room', 141),
  ('Individual Study Room', 142),
  ('Individual Study Room', 143),
  ('Individual Study Room', 144),
  ('Individual Study Room', 145),
  ('Individual Study Room', 146),
  ('Individual Study Room', 147),
  ('Individual Study Room', 148),
  ('Individual Study Room', 149),
  ('Individual Study Room', 150),
  ('Classroom', 151),
  ('Classroom', 152),
  ('Classroom', 153),
  ('Classroom', 154),
...
-- Dump completed on 2024-04-07 19:26:47